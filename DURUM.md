...
| `0f5078b` | Son genel inceleme (kullanıcı gibi 24 günlük veriyle bütün ekranlar gezildi). **Veri kaybı:** Ayarlar'daki "Depolama: x KB Sağlıklı ✓" satırına dokunup onaylamak 90 günden eski gün kayıtlarını siliyordu; hedef "yapılan gün" olduğundan tur 90 günden uzun sürebilir, ilerleme düşüyordu (ölçüm 75 → 55 gün). Artık temizlik yalnız 90 günden eski notları siler, satır sağlıklıyken dokunulmaz. **Tur kapanınca geri gidenler:** ayrıntıdaki "Son 12 Hafta" haritası (23 günün 2'si görünüyordu) ve rozetler (İlk Gün, 100/500 Gün, Dengeci, Geri Dönüşçü, Hafta Yıldızı) `h.days` okuyordu; artık `dayState`/`cDAll`. **Tur takvimi** başlangıç + hedef günde kesiliyordu: tur uzayınca son işaretler ve bugün görünmüyordu (13 günün 12'si). **Tanıtımı Tekrar Göster:** geri tuşu uygulamayı kapatıyor ve her açılışta tanıtım geliyordu, bir alışkanlık seçmeden çıkılamıyordu, 8 sınırı aşılıyordu (9 etkin), isim boş geliyordu; artık ilk ekranda geri tuşu ana ekrana döner, seçim isteğe bağlı ve kalan yer kadar. **Renkler:** tanıtımdan gelen üç alışkanlık üç yakın pembe alıyordu (`CL` sırasında 2 adım); tanıtım ve ekleme ekranı artık tonca en uzak rengi önerir (`farkliRenk`). **Widget:** sonradan eklenen alışkanlık widget'a hiç gelmiyordu, arşivlenen kalıyordu, "Tümünü Kaldır" hepsini geri getiriyordu (liste ilk açılışta donduruluyordu); artık kapatılanlar tutulur (`S.widgetGizli`, eski liste açılışta bırakılır, hepsi görünür başlar). "Tüm Verileri Sil" widget'ı boşaltmıyordu. Önizleme "62%" yazıyordu (widget "%62"). **Küçükler:** selamlamada isim iki kez kaçışlanıyordu ("&lt;" görünüyordu); ayrıntıda ad boşaltılınca kutu boş kalıyor, başka alışkanlığın adı alınabiliyordu; duraklatılmış başlığında "0 gündür · streak korunuyor". Test: `test_inceleme.js`.
| `8457689` | Telefonda görüldü: "Haftalık hedef 1/5" haftanın 5 gün sayıldığı sanıldı. 5 bir hedef (haftanın 7 gününden kaçı, kalemle 1–7) ama ekranda yazmıyordu; artık başlık "Hedef: haftada 5 gün", alt satır "4 gün daha · haftada 4 gün kaldı", düzenleyicide "Haftanın 7 gününden kaçında?". İki gerçek hata: yetişmeyecek hedefte "x gün daha" yazıyordu (cumartesi "3 gün daha", 2 gün kalmış; artık "Bu hafta yetişmez, en çok 4 gün olur"); hafta ortası başlayanda başlamadan önceki günler kaçırılmış sayılıyordu (cuma başlayan "1/5, 4 gün daha"; artık "İlk hafta: 3 gün", 1/3). Ayrıca kaydırınca başlık durum çubuğunun (saat, simgeler) arkasından akıyordu: köprü varken durum çubuğu yüksekliğinde zemin renginde şerit (`#sbPerde`). Test: `test_inceleme.js` (HAFTA, DURUM ÇUBUĞU).
| `12884b7` | Sıradan bir kullanıcı kurgusuyla (23 yaşında, kılavuz okumaz) 4 haftalık kullanım oynatıldı. **"Geri Al" balonu hiç görünmüyordu:** `.undo` `bottom:calc(var(--nh)+16px)` geçersizdi (`calc`'ta `+` boşluksuz), balon sayfanın sonuna, ekranın dışına düşüyordu; yanlış basılan "Yapamadım" geri alınamıyordu. **Seri:** bir gün açmamak seriyi hemen "Başla!"ya düşürüyor, puanı azaltıyordu (24 → 20); o gün hâlâ doldurulabilirken. Artık son 3 günün işaretsiz günü seriyi bozmaz. **Gece yarısı:** 00:40'ta "Tamamlandı" salıya yazılıyordu, kullanıcı pazartesi için basmıştı; artık 05:00'e kadar balon "Salı için kaydedildi" der ve "Düne yaz" sunar. **Gizli alışkanlık:** liste halka sekmesine göre süzülüyor, "Bırakmak" tarafında bugün bekleyen alışkanlık hiç görünmüyordu (başlık 0/3, listede 2 kart); artık listenin altında "Bırakmak tarafında bugün 1 alışkanlık bekliyor · Göster". **Haftalık özet** yalnız pazar açılınca çıkıyordu; artık pazar kaçırılırsa geçen haftanınki bir kez. Günlük mesaj üç haftalık kullanıcıya "Henüz başlamadın" diyordu → "Bugün henüz başlamadın". Test: `test_kullanici.js`; `test_streak.js`'teki "işaretsiz gün seriyi kırar" senaryosu doldurma süresi dışındaki güne taşındı.
| (son commit) | Kullanıcı isteği: onay ve bilgi pencereleri tarayıcının/Android'in sistem pencereleriydi (`confirm`/`alert`), temaya uymuyordu. 12 yerin hepsi uygulama içi pencereye (`sor`/`bilgi`/`pencere`) taşındı: iki temaya uyan kart, simge, Playfair başlık, 48 px düğmeler (onay mor, tehlikeli işlem mercan, vazgeç gri); geri tuşu, dışarı dokunma ve Esc vazgeçer. Metinler yeniden yazıldı ("Emin misin?" yerine ne olacağı). Yedek yüklemede "Tamam = Üzerine yaz / İptal = Ekle" sorusu açık seçeneklere dönüştü (Mevcutlara Ekle / Üzerine Yaz, ikincisi ayrıca onaylanır). Alışkanlık silme penceresinde "Arşivle" seçeneği. Hedef düşürme sorusu turun tamamlanacağını söyler. Test: `test_pencere.js`; pencere ortak ekran turunda (`pencere`: kontrast, taşma). `test_charts.js`'te tarihe bağlı eski bir test hatası düzeltildi ("3 gün önce = geçen hafta" yalnız pazartesi–çarşamba doğruydu; perşembe günü kırmızıya döndü).

Testler: uygulama için 1091 senaryo, Firebase kuralları için 59 senaryo. Hepsi geçiyor.
