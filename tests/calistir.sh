...
for t in tests/test_streak.js tests/test_round.js tests/test_xp.js \
         ...
         tests/test_remind.js tests/test_turkapanis.js \
         ...
         tests/test_uzunad.js tests/test_altgorunum.js tests/test_bosana.js tests/test_kisaekran.js tests/test_duraklat.js tests/test_metin.js tests/test_odabaslik.js tests/test_haftaozet.js tests/test_partnerozet.js tests/test_davet.js tests/test_geritusu.js tests/test_kopru.js tests/test_ustbosluk.js tests/test_widgettema.js tests/test_oda.js tests/test_inceleme.js tests/test_kullanici.js tests/test_pencere.js; do
