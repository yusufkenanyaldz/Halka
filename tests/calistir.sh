...
for t in tests/test_streak.js tests/test_round.js tests/test_xp.js \
         ...
         tests/test_uzunad.js tests/test_altgorunum.js tests/test_bosana.js tests/test_kisaekran.js tests/test_duraklat.js tests/test_metin.js tests/test_odabaslik.js tests/test_haftaozet.js; do
